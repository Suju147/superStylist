...
class FashionTips extends React.Component {
    render ()
    {
        ...
        Here, we discuss a list of fashion tips, who want to look fascinating, without the need of gaining weight to fill out their wardrobe pieces.</p>
          <div className="cardCollection">
            ...
            <div className="cardCollection">
            <div className="card" style={{marginLeft:"10%"}}> 
                <img className="image" src="https://i.pinimg.com/564x/67/9d/8c/679d8c4ee4ccc7116d8c3daabacc8618.jpg" alt="Denim Jeans"></img>
                <h1>Ideas for Thin Guys</h1>
                <p>Fashion styling tips and outfit ideas for Skinny guys.</p>
                <p><button className="tips">Tips</button></p>
            </div>
            <div className="card"> 
                <img className="image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScSE1ugu3k36_qz5idGoBOJCFlKVEW0tljHQ&usqp=CAU" ></img>
                <h1>Ideas for Large Man</h1>
                <p>Fashion styling tips and outfit ideas for Large Man.</p>
                <p><button className="tips">Tips</button></p>
            </div>
            <div className="card"> 
                <img className="image" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQX2_ZfTun90UvAw--shKXIsmG9on1e6VRo3g&usqp=CAU"></img>
